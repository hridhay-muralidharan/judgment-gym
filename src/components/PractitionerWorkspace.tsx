...
function ReflectionStep({ onNext }: { onNext: () => void }) {
  return <><StepIntro label="04 · Model review" title="A mirror Maya can correct." copy="The model offers a few tentative observations. Maya’s account stays visible, and her correction is part of the report." /><div className="guided-reflection-grid"><div className="guided-account compact"><span className="section-label">Maya’s account</span><blockquote>“I felt exposed and immediately started thinking that I was failing again. I answered briefly and wanted to leave.”</blockquote><span className="guided-authorship">Client-authored</span></div><div className="guided-observations"><span className="section-label">Model-suggested observations</span><article><small>Model suggestion · Emotion awareness</small><h4>Criticism may have become a signal to protect yourself quickly.</h4><p>Evidence: you describe feeling exposed, answering briefly, and wanting to leave.</p><b>Fits this moment</b></article><article><small>Model suggestion · Metacognition</small><h4>The first interpretation may have narrowed the options you could see.</h4><p>Evidence: “I am failing again” appeared before you explained what you needed.</p><b>Depends on context</b></article><div className="guided-correction"><span className="section-label">Maya’s correction · Client-authored</span><p>“The important part is not becoming calm immediately. It is noticing that I have more than one possible next step.”</p></div></div></div><div className="guided-action-row"><ContinueButton onNext={onNext}>Try the changed condition</ContinueButton><span>Next: a constructed exercise</span></div></>
}

function ConstructedStep({ onNext }: { onNext: () => void }) {
  return <><StepIntro label="05 · Constructed situation" title="Change one condition." copy="The demo gives Maya more time and trusted support after the conversation. It is an exercise for noticing what moves." /><div className="guided-constructed"><div className="constructed-label"><span>Constructed situation · For exploration</span><b>Text practice · Cognitive flexibility</b></div><h4>The same review meeting, with more room afterward</h4><p>Imagine your manager points out the same gaps. This time, you have the evening free and a person you trust is available afterward. What do you say or do before leaving the meeting?</p><div className="guided-seeded-response"><span className="section-label">Maya’s response · Client-authored</span><blockquote>“I would still feel the embarrassment, but I might ask which gap matters most and say that I want to come back with a clearer version tomorrow. Knowing I could talk it through afterward makes it less urgent to escape.”</blockquote></div><div className="guided-comparison"><div><small>What changed</small><p>More time and trusted support made it easier to stay with the conversation.</p></div><div><small>What stayed</small><p>The criticism still activated embarrassment and the wish to protect herself.</p></div></div></div><div className="guided-action-row"><ContinueButton onNext={onNext}>See Maya’s report</ContinueButton><span>Next: compare and carry forward</span></div></>
}
