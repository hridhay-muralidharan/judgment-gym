type Props = { onBegin: () => void; onStory: () => void; onPrivacy: () => void; hasHistory: boolean; onThreads: () => void; allComplete: boolean }

export function Welcome({ onBegin, onStory, onPrivacy, hasHistory, onThreads, allComplete }: Props) {
  return <section className="welcome page-grid">
    <div className="welcome-copy">
      ...
      <div className="welcome-actions">
        ...
        <button className="text-button" onClick={onStory}>Show me about yourself <span>↗</span></button>
      </div>
