...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      {stage === 'welcome' && <Welcome onBegin={begin} onPrivacy={() => setStage('privacy')} hasHistory={history.length > 0} onHistory={() => { setSelectedReflectionId(null); setStage('threads') }} />}
