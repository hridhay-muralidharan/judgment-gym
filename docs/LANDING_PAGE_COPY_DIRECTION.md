...
## What strong category products do

Current mental-health, coaching, and fitness products tend to follow a simple sequence:

1. lead with a short, memorable promise;
2. name an everyday outcome or problem;
3. show who the product is for;
4. explain the product mechanism in a few concrete verbs;
5. show the experience before asking for commitment.
