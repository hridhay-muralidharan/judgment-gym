...
export function persistPractice(state: Pick<PracticeState, 'response' | 'correction' | 'threads' | 'tension' | 'synthesis' | 'history' | 'scenarioIndex' | 'details' | 'probe' | 'simulationResponse' | 'transferNote' | 'journeyDraft' | 'journeyModel' | 'journeyMode'>): void {
